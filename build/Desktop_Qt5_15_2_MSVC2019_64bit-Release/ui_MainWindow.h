...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonMsg1->setObjectName(QString::fromUtf8("pushButtonMsg1"));

        verticalLayout->addWidget(pushButtonMsg1);

        pushButtonMsg2 = new QPushButton(centralwidget);
        pushButtonMsg2->setObjectName(QString::fromUtf8("pushButtonMsg2"));

        verticalLayout->addWidget(pushButtonMsg2);

        pushButtonSavePng = new QPushButton(centralwidget);
        pushButtonSavePng->setObjectName(QString::fromUtf8("pushButtonSavePng"));
